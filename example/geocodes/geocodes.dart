...
//
//
//var geocodesSearchButton = react.registerComponent(() => new _GeocodesSearchButton());
//
//class _GeocodesSearchButton extends ShadowDom {
//  @override
//  getDefaultProps() => super.getDefaultProps()..addAll({
//    'componentStyles': ShadowDomCssStyleDeclarations({
//      ShadowDomSelector.host(): CssStyleDeclaration()
//        ..fontFamily = 'Helvetica, Arial, sans-serif'
//        ..color = 'rebeccapurple'
//        ..opacity = '.1'
//        ..willChange = 'opacity'
//        ..transition = 'opacity 300ms ease-in-out',
//      ShadowDomSelector.host(':hover'): CssStyleDeclaration()
//        ..opacity = '1.0',
//      ShadowDomSelector.hostContext('.bar'): CssStyleDeclaration()..color = 'blue',
//      ShadowDomSelector.selector('.foo'): CssStyleDeclaration()..color = 'red',
//    }),
//  });
//}
//
...
////        ]),
//
//        geocodesSearchButton({'key': 'button', 'customElementName': 'geocodes-search-button'}, [
//          react.div({
//            'key': 'button',
//            'className': 'btn btn-primary',
//            'type': 'submit',
...
void main() {
  ...
  react_dom.render(
    react.div({}, [
      styledButton({'className': 'danger'}, ['danger']),
      styledButton({'className': 'warning'}, ['warning']),
    ])
